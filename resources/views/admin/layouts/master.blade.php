                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{ route('admin#userList') }}">
                                <i class="fas fa-clipboard-list"></i>User List</a>
                        </li>
                        <li>
                            <a href="{{ route('admin#userShowContact') }}">
                                <i class="fas fa-comment-alt"></i>Contact Messages</a>
                        </li>
                                                ...
                                                <div class="image">
                                                    <a href="#">
                                                        @if (Auth::user()->image == null)
                                                            @if (Auth::user()->gender == 'male')
                                                                <img src="{{ asset('image/default.png') }}"
                                                                    class="img-thumbnail shadow-sm" width="100px"
                                                                    alt="Default" />
                                                            @else
                                                                <img src="{{ asset('image/female_default.png') }}"
                                                                    class="img-thumbnail shadow-sm" width="100px"
